...
export default function FiltroTipos({ value, onChange }) {
  ...
  const SelectedIcon = selectedTipo.icon;
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <button
        ...
        "
      >
        <SelectedIcon size={18} className="text-purple-500" />
      ...
      {open && (
        <div
          className="
            absolute right-0 mt-2 w-56 sm:w-52 max-w-[90vw]
            ...
            return (
              <button
                ...
                className="
                  ...
                  justify-between text-gray-700 hover:bg-purple-50 
                  transition
                "
              >
                <div className="flex items-center gap-2">
                  <Icono size={17} className="text-gray-600" />
                  {t.label}
                </div>
