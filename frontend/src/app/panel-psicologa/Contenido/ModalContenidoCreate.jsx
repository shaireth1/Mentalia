  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-xl rounded-2xl p-6 shadow-lg relative">
        ...
        <h2 className="text-xl font-semibold mb-5">Subir Nuevo Contenido</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            <select className="w-1/2 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none">
